              ...
              children: <Widget>[
                ...
                Transform.translate(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      borderRadius:
                          BorderRadius.all(Radius.elliptical(215.0, 215.0)),
                      color: const Color(0xfff37a83),
                      border: Border.all(
                          width: 1.0, color: const Color(0xfff37a83)),
                    ),
                  ),
                ),
                Transform.translate(
