    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            offset: Offset(-5.0, 44.0),
            child: Stack(
              children: <Widget>[
                Transform.translate(
                  offset: Offset(120.0, 261.0),
                  child: Stack(
                    children: <Widget>[
                      Transform.translate(
                ...
                Transform.translate(
                  offset: Offset(116.0, 499.0),
                  child: Container(
                    width: 380.0,
                    height: 380.0,
                    decoration: BoxDecoration(
                      borderRadius:
                          BorderRadius.all(Radius.elliptical(190.0, 190.0)),
                      color: const Color(0xff020202),
                      border: Border.all(
                          width: 1.0, color: const Color(0xff5ca9af)),
                    ),
                  ),
                ),
              ],
...
const String _svg_66xsqu =
    '<svg viewBox="91.0 474.0 430.0 430.0" ><path transform="translate(91.0, 474.0)" d="M 215 0 C 333.7412109375 0 430 96.2587890625 430 215 C 430 333.7412109375 333.7412109375 430 215 430 C 96.2587890625 430 0 333.7412109375 0 215 C 0 96.2587890625 96.2587890625 0 215 0 Z" fill="#9fc6c9" stroke="#5ca9af" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
